...
function adb-screen-record() {
  ...
  adb shell screenrecord /sdcard/screen-record.mp4
}

function adb-screen-record-pull {

  dir=${DIR_SCREENSHOTS}

  adb pull /sdcard/screen-record.mp4 ${dir}
  adb shell rm /sdcard/screen-record.mp4
}
